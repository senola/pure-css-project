    ...
    grunt.initConfig({
        ...
        concat: { // 文件合并
            dist: { 
                ...
                dest: 'pure-css-project/javascript/'
            }
        },
        uglify: { //文件压缩
            build: {
        ...
        watch: { // 文件监听
            ...
            scripts: {
                files: ['pure-css-project/javascript/*.js'],
                //tasks: ['concat', 'uglify'],
                options: {
                    spawn: false,
                }
            ...
            html: {
                files: ['pure-css-project/*.html'],
            },
            css: {
                files: ['pure-css-project/sass/*.scss'],
                tasks: ['sass'],
                options: {
                    spawn: false,
                }
        ...
        sass: {  // sass预处理器
            dist: {  
                  ...
                  files: { 
                    'pure-css-project/stylesheet/pure-css-project.css': 'main.scss', // '目标文件': '源文件'
                  }
            }
        }
    });
